...
class BookController extends GetxController {
  ...
  String? getUsernameFromFirebase() {
    ...
    // Check if the user is signed in and if displayName is available
    if (user != null && user.displayName != null) {
      return user.displayName;
    } else {
      return null; // Handle case where username is not available
    }
  }
  ...
  void createBook() async {
    ...
    var newBook = BookModel(
      ...
      rating: rating.text, // Include the rating value
      numberofRatings: '10',
    );
    ...
    auth.clear();
    price.clear();
    rating.clear(); // Clear the rating value after storing
    imageUrl.value = "";
    pdfUrl.value = "";
